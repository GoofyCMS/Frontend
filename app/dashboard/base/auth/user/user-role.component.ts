...
export class UserRoleComponent extends CrudDialogManagerComponent implements OnInit {
    constructor(@Inject(UnitOfWorkFactory) uowf: UnitOfWorkFactory,
                ...
                fc: FormlyConfig,
                fb: FormBuilder) {
        super(uowf, logger, router, 'administration', 'IdentityUserRoleItem', fm, fc, fb);
    }
