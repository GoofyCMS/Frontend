...
export class Field implements OnInit {
  ...
  @Input()
  public get modelCheckbox(): any[] {
    return this._modelCheckbox;
  }

  public set modelCheckbox(value: any[]) {
  ...
  createControlCheckbox(): AbstractControl {
    return new Control(this._modelCheckbox || [], this.field.validation);
  }
}
